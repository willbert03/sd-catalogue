      ...
      function n(n) {
        ...
        (e.call(this, n),
          ...
          (i.ambientLight.color = new THREE.Color(
            v(n.ambientLightColor, s.ambientLightColor),
          )),
    ...
    var i = (function (t) {
      function n(n, i) {
        (((n = n || {}).segments = n.segments || 50),
          ...
          (this.singlePageMode =
            n.singlePageMode ||
            (A ? e.SINGLE_PAGE_MODE.BOOKLET : e.SINGLE_PAGE_MODE.ZOOM)),
          (this.type = "Book"));
      }
      return (
        j(n, t),
        ...
        resize: function () {
          ...
          if (
            ...
            var I = u.find(".df-ui-controls").height(),
              S =
                h.paddingTop +
                (h.controlsPosition == e.CONTROLSPOSITION.TOP ? I : 0),
              E = h.paddingRight,
              k =
                h.paddingBottom +
                (h.controlsPosition == e.CONTROLSPOSITION.BOTTOM ? I : 0),
              T = h.paddingLeft,
              O =
                (S = isNaN(S) ? 0 : C(S, 0, S)) +
                (k = isNaN(k) ? 0 : C(k, 0, k)),
    ...
    Z = (function (n) {
      ...
      function o(n, o) {
        ...
        ((a.type = "BookCSS"),
          ...
          (a.pageMode =
            n.pageMode ||
            (A || a.pageCount <= 2 ? e.PAGE_MODE.SINGLE : e.PAGE_MODE.DOUBLE)),
          (a.singlePageMode =
            n.singlePageMode ||
            (A ? e.SINGLE_PAGE_MODE.BOOKLET : e.SINGLE_PAGE_MODE.ZOOM)),
        ...
        (o.prototype = {
          ...
          pan: function (e) {
            ...
            ((this.left = Math.round(C(i, -this.shiftWidth, this.shiftWidth))),
              (this.top = Math.round(
                C(o, -this.shiftHeight, this.shiftHeight),
              )),
